...
* about 832 Gameplay Cards with at least one text revision
  ...
  * 863 `test_validated_executable` definitions
  * 116 timing-only `manual_resolution` definitions
  * registry-entry executable coverage is currently 88.15%
