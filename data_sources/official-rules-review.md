...
| `effect_binding` | Card text is the official source for card abilities. | Raw effect text and later tags/DSL/executable behavior should bind to `card_id`, not to Member/Live attribute records. |
